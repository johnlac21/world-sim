...
CREATE TABLE "Office" (
    ...
    CONSTRAINT "Office_worldId_fkey" FOREIGN KEY ("worldId") REFERENCES "World" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "Office_countryId_fkey" FOREIGN KEY ("countryId") REFERENCES "Country" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
INSERT INTO "new_Person" ("age", "athleticism", "birthYear", "charisma", "countryId", "createdAt", "discipline", "empathy", "endurance", "id", "intelligence", "isAlive", "isPlayer", "leadership", "name", "parent1Id", "parent2Id", "strength", "wit", "worldId") SELECT "age", "athleticism", "birthYear", "charisma", "countryId", "createdAt", "discipline", "empathy", "endurance", "id", "intelligence", "isAlive", "isPlayer", "leadership", "name", "parent1Id", "parent2Id", "strength", "wit", "worldId" FROM "Person";
DROP TABLE "Person";
