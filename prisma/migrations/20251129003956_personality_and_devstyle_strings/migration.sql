/*
  ...
  - Added the required column `personalityArchetype` to the `Person` table without a default value. This is not possible if the table is not empty.
  - Added the required column `personalitySubtype` to the `Person` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_Person" (
    ...
    "personalitySubtype" TEXT NOT NULL,
...
INSERT INTO "new_Person" ("adaptability", "age", "agreeableness", "ambition", "appearance", "athleticism", "birthYear", "charisma", "communication", "confidence", "countryId", "createdAt", "creativity", "developmentStyle", "discipline", "empathy", "endurance", "id", "integrity", "intelligence", "isAlive", "isPlayer", "judgment", "leadership", "memory", "name", "negotiation", "parent1Id", "parent2Id", "patience", "peakAge", "potentialOverall", "prestige", "reflexes", "riskTaking", "stability", "strength", "vitality", "worldId") SELECT "adaptability", "age", "agreeableness", "ambition", "appearance", "athleticism", "birthYear", "charisma", "communication", "confidence", "countryId", "createdAt", "creativity", "developmentStyle", "discipline", "empathy", "endurance", "id", "integrity", "intelligence", "isAlive", "isPlayer", "judgment", "leadership", "memory", "name", "negotiation", "parent1Id", "parent2Id", "patience", "peakAge", "potentialOverall", "prestige", "reflexes", "riskTaking", "stability", "strength", "vitality", "worldId" FROM "Person";
DROP TABLE "Person";
